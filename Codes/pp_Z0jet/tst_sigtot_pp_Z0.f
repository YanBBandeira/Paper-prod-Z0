...
c     =================================================================
      ...
      iset = 200001 !GBW !KS-2013-linear 
      call TMDinit(iset)
      call TMDset(iset)
...
cOPT      call VEGAS(6,vegasIntegrand,avgi,sd,chi2a)
cOPT      print*, avgi, "+-", sd  
...
c     -----------------------------------------------------------------
      ...
      ktp   = X(3)/(1.d0 - X(3))
cOLD      !kp_min + (kp_max - kp_min)*x(3)
      ktm   = X(4)/(1.d0 - X(4))
cOLD      !km_min + (km_max - km_min)*x(4)
      phip  = 2.d0*pi*x(5)
      phim  = 2.d0*pi*x(6)
...
cOLD     &  * ( kp_max - kp_min ) * ( km_max - km_min )
...
c     =================================================================
     ...
     *       mfVar,gfv,gfa)
      ...
      preTerms = alfem/(2.d0*pi2*(DSIN(2.d0*aW)**2.0d0))
